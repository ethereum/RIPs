...
In order to allow a gas estimation of the transaction prior signing, this function
should avoid reverting on invalid signature, and return `MAGIC_VALUE_SIGFAIL` instead.
...
```
(this is the same encoding the the above solidity method returns)
