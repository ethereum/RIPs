...
Note that the behavior of the `nonce` field in case `nonceKey != 0` is different and is defined in RIP-7712.
...
In RIP-7712 we propose a mechanism that uses the higher 192 bits of the `nonce` field.
