...
* *RIP-7560 Execution Frame*:
  ...
  An execution frame may contain inner call frames as well, but they are not "execution frames".
  An execution frame may either succeed or revert.
* *RIP-7560 Transaction Phase*:
  A set of RIP-7560 Execution Frames that form a single step in a RIP-7560 Transaction flow.
