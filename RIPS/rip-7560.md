...
* *RIP-7560 Call Frame*:
  ...
  A RIP-7560 call frame may contain inner call frames as well, but they are not referred to as "RIP-7560 call frames".
  A RIP-7560 call frame may either succeed or revert.
* *RIP-7560 Transaction Phase*:
  A set of RIP-7560 Call Frames that form a single step in a RIP-7560 Transaction flow.
...
| callGasLimit                  | QUANTITY       | Gas provided for the transaction execution RIP-7560 call frame                      |
...
| executionGasUsed             | QUANTITY         | The amount of gas actually used by the execution RIP-7560 call frame                                                                 |
...
In terms of block validity, all validation and execution RIP-7560 call frames may read and write any state when included in the block.
