...
A contract that does not implement RIP-7560 will cause `eth_esimateGasAA` to provide inconsistent results
and will risk sporadically reverting on out-of-gas errors on-chain.
