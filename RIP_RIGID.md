...
/ Aggregator]
    ...
    subgraph Agents
      ...
      GasAgent3[Cross-chain Protocol]
    end
...
This registry provides the canonical mapping, making it accessible to gas agents for reliable context to understand accepted tokens and facilitate cross-chain transfers or conversions.
